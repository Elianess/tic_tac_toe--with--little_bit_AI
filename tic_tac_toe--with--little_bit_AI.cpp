...
2)Вывевсти на экран правила
3)Определить кто ходит первым 
4)Отобразить поле 
5)Если никто не победил и не наступила ничья 
И если сейчас ход пользователя, то получить его ход 
6)Обновть игровое поле с учетом хода
7)Иначе вычислить ход компьютера
8)Обновить поле с учетом хда компьютера
9)Отобразить поле 
10)Передать ход сопернику
11)Поздравить победителя или объявить ничью
*/
